...
object PromptFactory {
    ...
    fun draftChapter(
        ...
        DIREKT ERZÄHLEN – UMSCHREIBUNGEN STRENG BEGRENZEN: Nenne Dinge, Gefühle und Ereignisse beim konkreten Namen. Der Leser muss in JEDEM Absatz ohne Rätseln verstehen, wer was tut und was passiert. VERBOTEN sind gehäufte Umschreibungs-Ketten: Benennungs-Vermeidung ("das, was sie waren", "etwas, das sie nicht benennen konnte"), Korrekturfiguren in Serie ("Nicht leergezogen, sondern ausgelöscht"), abstrakte Vergleiche ins Ungefähre ("wie eine Wand aus etwas Härterem als Luft"). HÖCHSTENS EINE Umschreibung pro Szene – sonst klare, direkte Sätze. Nicht sofort verständlich? Einfacher schreiben.
